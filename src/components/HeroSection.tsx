...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-pearl">
      {/* Floating Particles */}
      ...
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" viewBox="0 0 1920 1080" fill="none">
          <path
            d="M960 100 Q1200 300 1200 600 L1200 1080 L720 1080 L720 600 Q720 300 960 100Z"
            stroke="currentColor"
            strokeWidth="2"
            className="text-wine"
          />
          <path
            d="M1400 200 Q1600 350 1600 650 L1600 1080 L1200 1080 L1200 650 Q1200 350 1400 200Z"
            stroke="currentColor"
            strokeWidth="2"
            className="text-wine"
          />
          <path
            d="M520 200 Q320 350 320 650 L320 1080 L720 1080 L720 650 Q720 350 520 200Z"
            stroke="currentColor"
            strokeWidth="2"
            className="text-wine"
          />
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.h1
              className="font-display text-6xl lg:text-8xl font-bold text-wine mb-6 leading-tight lens-flare"
            ...
            <motion.p
              className="font-body text-xl lg:text-2xl text-wine/80 mb-8 font-light"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
            >
              An exclusive fashion universe for designers, models & creators
            </motion.p>
      ...
      >
        <div className="w-6 h-10 border-2 border-wine/30 rounded-full flex items-start justify-center p-2">
          <motion.div
